...
var difficulty = 4; // add variable difficulty
...
class Block {
	...
	this.difficulty = difficulty; //add difficulty
	this.nonce = nonce; // add nonce
    }
}
...
var initHttpServer = () => {
	...
	var newBlock = mineBlock(req.body.data); //call mineBlock with PoW	
...
// Generate next block old function
/*
var generateNextBlock = (blockData) => {
    var previousBlock = getLatestBlock();
    var nextIndex = previousBlock.index + 1;
    var nextTimestamp = new Date().getTime() / 1000;
    var nextHash = calculateHash(nextIndex, previousBlock.hash, nextTimestamp, blockData, difficulty, nonce);
